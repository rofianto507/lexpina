...
if(!isset($_SESSION["id"]) || !isset($_SESSION["nama"])) {
 ...
 if(empty($_SESSION['csrf_token'])) {
  ...
  if($_SERVER['REQUEST_METHOD']==='POST' && isset($_POST['hapus_id'])) {
    ...
    if($hapus_id) {
      $stmtDel = $pdo->prepare("UPDATE lokasi_kategoris SET status=0 WHERE id=:id");
      $stmtDel->execute([':id'=>$hapus_id]);
      header("Location: kategori-lokasi?status=hapus_sukses");
      exit;
    }
  }
?>
...
<html lang="en-US" dir="ltr">
  <head>
    ...
    <title>Kategori Lokasi | Peta Digital</title>
    ...
    <main class="main" id="top">
      <div class="container-fluid" data-layout="container">
        ...
        <div class="content">
            ...
            <div class="card-header">
              <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                  <h5 class="fs-0 mb-0"><span class="fas fa-thumbtack me-2 fs-0"></span> Kategori Lokasi</h5>
                </div>
            ...
            <div class="card-body bg-light">
              <div class="table-responsive">
                <table id="kategoriTable" class="display table table-striped table-bordered table-sm" >
                  ...
                  <?php
                    $no=1;
                    $stmt = $pdo->query("SELECT * FROM lokasi_kategoris WHERE status=1 ORDER BY id ASC");
          ...
          <!-- Modal Tambah Data Kategori lokasi -->
          <div class="modal fade" id="modalTambahKategori" tabindex="-1" aria-labelledby="modalTambahKategoriLabel" aria-hidden="true">
            <div class="modal-dialog">
              <form method="POST" id="formTambahKategori">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="modalTambahKategoriLabel">Tambah Kategori Lokasi</h5>
          ...
          <div class="modal fade" id="modalEditKategori" tabindex="-1" aria-labelledby="modalEditKategoriLabel" aria-hidden="true">
            <div class="modal-dialog">
              <form method="POST" id="formEditKategori">
                ...
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="modalEditKategoriLabel">Edit Kategori Lokasi</h5>
