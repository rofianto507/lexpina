...
// Langkah 1: Generate CSRF token jika belum ada/direfresh pada GET
if (empty($_SESSION['csrf_token']) || $_SERVER['REQUEST_METHOD'] !== 'POST') {
    // RANDOM_BYTES menggunakan PHP 7+
    $_SESSION['csrf_token'] = bin2hex(random_bytes(32));
}

if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST["submit"])) {
    // Langkah 3: Validasi CSRF token
    if (
                  ...
                  <div class="col-md-5 text-center bg-card-gradient">
                    <div class="position-relative p-4 pt-md-5 pb-md-7 light">
                      ...
                      <!--/.bg-holder-->
                        ...
                        <h3 class="text-white"><?php echo htmlspecialchars($app_name, ENT_QUOTES, 'UTF-8'); ?></h3>
                        <p class="opacity-75 text-white"><?php echo htmlspecialchars($long_description, ENT_QUOTES, 'UTF-8'); ?></p>
                        </div>
                    </div>
                       ...
                       <?php echo $login_message; ?>
                        <form  method="post" action="">
                          ...
                          <div class="mb-3">
                            ...
                            <input class="form-control" id="card-email" name="username" type="text" required autocomplete="username" />
                          </div>
                          <div class="mb-3">
                            <div class="d-flex justify-content-between">
                              <label class="form-label" for="card-password">Password</label>
                            </div>
                            <input class="form-control" id="card-password" name="password" type="password" required autocomplete="current-password" />
                          </div>
